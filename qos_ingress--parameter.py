...
parser.add_option("--ing_start", dest="ing_start",default="40", help="ing_start")
parser.add_option("--ing_num", dest="ing_num",default="1", help="ing_num")
(options, args) = parser.parse_args()

ip_OAM    = options.oam_ip
passwd    = options.passwd
action    = options.action
ing_start = int( options.ing_start )
ing_end   = ing_start + int( options.ing_num )
...
slot      = "1/1/1/1" 
lt_mode   = "downlink"
# action    = "1"        # [0:del] [1:add] [other:quit]
# ing_start = 40
# ing_end   = ing_start + 1
str_num   = 0
